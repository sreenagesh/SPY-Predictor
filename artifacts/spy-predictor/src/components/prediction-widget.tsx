...
import type { SpyPredictionResponse } from "@workspace/api-client-react";
...
export function PredictionWidget({ prediction: pred, updatedAt }: PredictionWidgetProps) {
        ...
        <div className="flex items-start justify-between mb-3">
          <div>
            <div className="flex items-center gap-2 mb-0.5">
              ...
              <span className="text-xs font-bold text-muted-foreground uppercase tracking-widest">Daily Market Outlook</span>
            </div>
            <p className="text-[10px] text-muted-foreground/50 ml-5">Daily bars · Not intraday</p>
          </div>
